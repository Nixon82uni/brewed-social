...
const FollowStore={
  async follow(followingId){const{error}=await sb.from('follows').insert([{follower_id:uid(),following_id:followingId}]);if(error&&error.code!=='23505')throw error;},
